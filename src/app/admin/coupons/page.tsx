      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl p-5 mb-6 shadow-luxe grid grid-cols-2 gap-3">
          ...
          <input
            ...
            onChange={(e) => setForm({ ...form, dollarOff: e.target.value })}
          />
          ...
          <button
            onClick={create}
            className="col-span-2 bg-maroon text-white py-2 rounded-lg font-semibold"
          >
            Create Coupon
          </button>
        </div>
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className={`text-sm px-3 py-1 rounded-full ${
                    c.active ? 'bg-green-100 text-green-700' : 'bg-zinc-200 text-zinc-500'
                  }`}
                >
